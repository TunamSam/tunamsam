...
import BotTelegram from "../assets/bot-telegram.png";

const projects = [
  {
    title: "Bot Telegram Dental Assistant",
    category: "Bot Telegram",
    description:
      "Bot Telegram untuk membantu dokter gigi dalam mengelola / memeriksa pasien di lapangan.",
    image: BotTelegram,
    tags: ["Node.js", "Bot Father", "Railway"],
  ...
  },
  {
    ...
    description:
      "Visualisasi data real-time dengan grafik dan laporan interaktif.",
    image:
      "https://images.unsplash.com/photo-1583932692875-a42450d50acf?auto=format&fit=crop&w=1080&q=80",
  ...
  },
  {
    ...
    description:
      "Pengalaman mobile banking yang aman, simpel, dan mudah digunakan.",
    image:
  ...
  },
  {
    ...
    category: "Web App",
    description:
      "Aplikasi untuk mengelola data siswa, guru, dan administrasi sekolah.",
    image:
  ...
  },
  {
    ...
    description:
      "Landing page conversion-focused untuk meningkatkan penjualan produk digital.",
    image:
      "https://images.unsplash.com/photo-1556155092-490a1ba16284?auto=format&fit=crop&w=1080&q=80",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Beberapa proyek terbaik yang pernah kami kerjakan untuk klien dari
            berbagai bidang.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          >
            <span>{showAll ? "Tampilkan Sedikit" : "Lihat Semua Proyek"}</span>
            <ArrowRight
