...
export function CTA() {
  return (
    <section id="cta" className="py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button className="group px-8 py-4 bg-white text-blue-600 rounded-xl hover:bg-gray-100 transition-all flex items-center gap-2 shadow-xl hover:shadow-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-blue-200 text-sm mb-2">Email Us</div>
              <div className="text-white font-medium">hello@tunamsam.com</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-blue-200 text-sm mb-2">Call Us</div>
              <div className="text-white font-medium">+1 (555) 123-4567</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-blue-200 text-sm mb-2">Response Time</div>
